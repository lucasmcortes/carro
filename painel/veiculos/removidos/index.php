								...
								<?php
									...
									foreach ($listaveiculos as $veiculos) {
										...
										if ($veiculo['ativo']=='N') {
											...
											($veiculo['caracterizado']=='S') ? $caracterizado = 'Sim' : $caracterizado = 'Não';
